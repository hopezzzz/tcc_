...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
                            <div class="panel-heading">
                            <button class="close" type="button" data-dismiss="modal">×</button>
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Finance Details</h3>
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> Payments</h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
                <div class="col-sm-4">
                            ...
                            <div class="col-sm-2">
                              <select class="form-control" ng-model='filter.country_status'>
                                ...
                                foreach($src as $sr)
                                {
                                  echo "<option value='".$sr['fin_country']."'>".$sr['fin_country']."</option>";
                                }
                                ?>
                              </select>
                            </div>
                                  ...
                                  <table class="table table-striped jambo_table bulk_action">
                                    <thead>
                                        <tr>
											...
											<th>Commission</th>
											<th>MarketPlace</th>
											<!---<th>FixedClosingFee</th>
											<th>GiftChargeback</th>
											<th>ShipChargeback</th>
                                            <th>VarCloseFee</th> --->
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        <tr    ng-show='prodList.length>0' ng-repeat="tnx in prodList " >
                                            <td >{{tnx.order_id}}</td>
											<td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.sku}}</td>
											<td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.itemid}}</td>
											<td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.principal}}</td>
										    <td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.tax}}</td>
											<!---<td>{{tnx.giftwrap}}</td>
											<td>{{tnx.giftwraptax}}</td>
											<td>{{tnx.shippingcharge}}</td>
											<td>{{tnx.shippingtax}}</td> --->
									        <td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.fbafee}}</td>
											<td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.commission}}</td>
											<td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal" style="text-transform:uppercase">{{tnx.fin_country}}</td>
											<!---<td>{{tnx.fixedclosingfee}}</td>
											<td>{{tnx.giftwrapchargeback}}</td>
											<td>{{tnx.shippingchargeback}}</td>
											<td>{{tnx.variableclosingfee}}</td> --->
                                        </tr>
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."order_finance_data/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."order_finance_data/export_datasss/"?>";
	 var export_list_url        =   "<?php echo $baseurl."order_finance_data/export_data"?>";
