...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> FBA Replacements Report</h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
                                  ...
                                  <table class="table table-striped jambo_table bulk_action">
                                    <thead>
                                        <tr>
											...
											<th>SKU</th>
										    <th>Shipment Date</th>
											<th>Replace Order No</th>
											<th>Orginal Order No</th>
                                            <th>Quantity</th>
											<th>Relacement Reason Code</th>
                                    ...
                                    <tbody>
                                        <tr    ng-show='prodList.length>0' ng-repeat="tnx in prodList " >
                                            <td >{{tnx.asin}}</td>
											<td >{{tnx.sku}}</td>
									    	<td >{{tnx.shipment_date}}</td>
											<td >{{tnx.replacement_amazon_order_id}}</td>
											<td >{{tnx.original_amazon_order_id}}</td>
										    <td >{{tnx.quantity}}</td>
											 <td >{{tnx.replacement_reason_code}}</td>
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."order_fba_shipment_replacement_data/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."order_fba_shipment_replacement_data/export_datasss/"?>";
	 var export_list_url        =   "<?php echo $baseurl."order_fba_shipment_replacement_data/export_data"?>";
