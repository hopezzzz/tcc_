...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> FBA Inventory Health Report </h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."fba_inventory_health_data/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."fba_inventory_health_data/export_datasss/"?>";
	 var export_list_url        =   "<?php echo $baseurl."fba_inventory_health_data/export_data"?>";
