...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
                            ...
                            <button class="close" type="button" data-dismiss="modal">×</button>
                              ...
                              <div class="col-sm-5">
                                 <table class="table table-condensed table-striped">
								   ...
								   <tr><td>Ship Price</td><td class="text-right">{{ord.ship_price}}</td></tr>
								   <tr><td>Ship Tax</td><td class="text-right">{{ord.ship_tax}}</td></tr>
								   <tr><td>Item Promotional Discount</td><td class="text-right">{{ord.itm_promo_discount}}</td></tr>
								   <tr><td>Shipping Promotional Discount</td><td class="text-right">{{ord.ship_promo_discount}}</td></tr>
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> Requested or Scheduled Flat File Order Report</h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."orders_report_flat_list/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."orders_report_flat_list/export_datasss/"?>";
	 var export_list_url        =   "<?php echo $baseurl."orders_report_flat_list/export_data"?>";
    ...
    var update_product_info=function(product_info)
    {
       return $http({
                      method: "post",
                      url:"<?php echo $baseurl.'orders_report_flat_list/update_product_info'?>",
                      data:{
