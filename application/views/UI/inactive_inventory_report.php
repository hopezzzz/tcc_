...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> Inactive Listings Report</h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
                                  ...
                                  <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
                                        <tr    ng-show='prodList.length>0' ng-repeat="tnx in prodList " >
									    	...
									    	<td>{{tnx.item_name |limitTo:50}}</td>
											<td>{{tnx.price}}</td>
											<td>{{tnx.item_condition}}</td>
										    <td>{{tnx.open_date}}</td>
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."inactive_inventory_report/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."inactive_inventory_report/export_datasss/"?>";
	 var export_list_url        =   "<?php echo $baseurl."inactive_inventory_report/export_data"?>";
    ...
    var update_product_info=function(product_info)
    {
       return $http({
                      method: "post",
                      url:"<?php echo $baseurl.'inactive_inventory_report/update_product_info'?>",
                      data:{
