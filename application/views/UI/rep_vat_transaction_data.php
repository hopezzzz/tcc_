...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> Amazon VAT Transaction Report</h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                 <div class="table-responsive">
                                  <table class="table table-striped jambo_table bulk_action">
                                    <thead>
                                        <tr>
                                            <th>Transaction Event ID</th>
											<th>SKU</th>
										    <th>ASIN</th>
											<th>Activity Period</th>
                                            <th>Transaction Type</th>
											<th>Tax Calculation Date</th>
											<th>Transaction Depart Date</th>
											<th>Transaction Arrival Date</th>
                                    ...
                                    <tbody>
                                        <tr    ng-show='prodList.length>0' ng-repeat="tnx in prodList " >
                                            <td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal"  class="col-sm-2">{{tnx.trans_event_id}}</td>
											<td  ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal" class="col-sm-2">{{tnx.seller_sku}}</td>
										    <td><a style="color:green;font-weight:600" target="_blank" href='https://www.amazon.{{tnx.country}}/dp/{{tnx.prod_asin}}'>{{tnx.prod_asin}}</a></td>
											<td  ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal"class="col-sm-1">{{tnx.activity_period}}</td>
											<td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.trans_type}}</td>
										    <td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.tax_cal_date}}</td>
											<td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.trans_depart_date}}</td>
											<td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.trans_arraival_date}}</td>
											<td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.trans_compile_date}}</td>
									        <td ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal">{{tnx.qty}}</td>
											 <td  ng-click='show_order_details(tnx)' data-target="#myModal" data-toggle="modal"style='text-transform:uppercase'>{{tnx.country}}</td>
                                        </tr>
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."rep_vat_transaction_data/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."rep_vat_transaction_data/export_datasss/"?>";
	 var export_list_url        =   "<?php echo $baseurl."rep_vat_transaction_data/export_data"?>";
    ...
    var update_product_info=function(product_info)
    {
       return $http({
                      method: "post",
                      url:"<?php echo $baseurl.'rep_vat_transaction_data/update_product_info'?>",
                      data:{
