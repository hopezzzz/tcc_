...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> FBA Stranded Inventory Report</h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
                                  ...
                                  <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
                                        <tr    ng-show='prodList.length>0' ng-repeat="tnx in prodList " >
                                            <td >{{tnx.primary_action}}</td>
											<td >{{tnx.date_stranded}}</td>
											<td >{{tnx.status_primary}}</td>
											<td >{{tnx.status_secondary}}</td>
											<td >{{tnx.asin}}</td>
											<td >{{tnx.sku}}</td>
										    <td >{{tnx.fnsku}}</td>
											<td >{{tnx.prod_name |limitTo:50 }}</td>
											<td >{{tnx.fulfilled_by}}</td>
											<td >{{tnx.your_price}}</td>
											<td>fulfillable_qty</td>
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."stranded_inv_ui_data/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."stranded_inv_ui_data/export_data/"?>";
	 var export_list_url        =   "<?php echo $baseurl."stranded_inv_ui_data/export_data"?>";
