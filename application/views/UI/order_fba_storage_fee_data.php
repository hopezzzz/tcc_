...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> FBA Storage Fees Report</h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
                                  ...
                                  <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
                                        <tr    ng-show='prodList.length>0' ng-repeat="tnx in prodList " >
                                            <td >{{tnx.asin}}</td>
											<td >{{tnx.fnsku}}</td>
									    	<td >{{tnx.product_name}}</td>
											<td >{{tnx.fulfillment_center}}</td>
											<td >{{tnx.month_of_charge}}</td>
										    <td >{{tnx.country_code}}</td>
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."order_fba_storage_fee_data/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."order_fba_storage_fee_data/export_datasss/"?>";
	 var export_list_url        =   "<?php echo $baseurl."order_fba_storage_fee_data/export_data"?>";
