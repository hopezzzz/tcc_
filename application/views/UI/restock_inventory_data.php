...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> Restock Inventory Report</h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
                                  ...
                                  <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
                                        <tr    ng-show='prodList.length>0' ng-repeat="tnx in prodList " >
                                            <td >{{tnx.res_sku}}</td>
											<td >{{tnx.res_fn_sku}}</td>
											<td >{{tnx.res_asin}}</td>
											<td >{{tnx.res_cond}}</td>
											<td >{{tnx.res_price}}</td>
											<td >{{tnx.res_fulfill}}</td>
										    <td >{{tnx.res_country}}</td>
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."restock_inventory_data/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."restock_inventory_data/export_datasss/"?>";
	 var export_list_url        =   "<?php echo $baseurl."restock_inventory_data/export_data"?>";
...
crawlApp.controller('productCtrl', ['$scope','$parse','$window','productFactory','$http','limitToFilter',function($scope,$parse,$window,productFactory,$http,limitToFilter) {        
  ...
  $scope.block_site=function()
    ...
    $scope.currentPage = 0;
    $scope.sortorder='res_recom_order_date';
