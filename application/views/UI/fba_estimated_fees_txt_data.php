...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> FBA Fee Preview Report</h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
                                  ...
                                  <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
                                        <tr    ng-show='prodList.length>0' ng-repeat="tnx in prodList " >
                                            <td >{{tnx.asin}}</td>
											<td >{{tnx.sku}}</td>
									    	<td >{{tnx.product_name | limitTo:50}}</td>
											<td >{{tnx.product_group}}</td>
											<td >{{tnx.brand}}</td>
										    <td >{{tnx.your_price}}</td>
											<td >{{tnx.sales_price}}</td>
											<td >{{tnx.estimated_fee_total}}</td>
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."fba_estimated_fees_txt_data/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."fba_estimated_fees_txt_data/export_datasss/"?>";
	 var export_list_url        =   "<?php echo $baseurl."fba_estimated_fees_txt_data/export_data"?>";
