...
<div id="myModal" class="modal fade" role="dialog" style="margin-left:150px;">
  ...
  <div class="card panel ">
    ...
    <div class="row">
        ...
        <div class="card panel ">
            <div class="panel-heading">
                   <h3 class="panel-title"><i class="fa fa-database"></i> Flat File Settlement Subscription Fees Data </h3>
            </div>
            <div class="panel-body" >
            <div class="row">
            <div class="col-sm-12">
                                  ...
                                  <table class="table table-striped jambo_table bulk_action">
                                    ...
                                    <tbody>
                                        <tr  ng-show='prodList.length>0' ng-repeat="tnx in prodList " >
                                            <td class="col-sm-2">{{tnx.settlement_id}}</td>
											<td>{{tnx.transaction_type}}</td>
											<td>{{tnx.posted_date}}</td>
										    <td>{{tnx.other_amt}}</td>
                                        </tr>
...
crawlApp.factory('productFactory', ['$http', '$q','limitToFilter', function($http,$q,limitToFilter) {
    ...
    var product_list_url        =   "<?php echo $baseurl."subscription_fee_data/get_product_list/"?>";
	var d_path        =   "<?php echo $baseurl."subscription_fee_data/export_datasss/"?>";
	 var export_list_url        =   "<?php echo $baseurl."subscription_fee_data/export_data"?>";
    ...
    var update_product_info=function(product_info)
    {
       return $http({
                      method: "post",
                      url:"<?php echo $baseurl.'subscription_fee_data/update_product_info'?>",
                      data:{
