...
class Manage_users extends CI_Controller {
  ...
  {
    $sql="SELECT scr_u_id as uid,scr_firstname as fname,scr_lastname as lname,scr_uname as email,scr_password as password,scr_is_verified as is_verified,scr_active as is_active,trial_count as credits,
                 DATE_FORMAT(joined_on,'%Y-%m-%d') as joined,profile_img as pro_img,scr_is_admin,IF(scr_is_admin='1','Admin','User') as position
          FROM `scr_user`
          
          GROUP by scr_u_id ORDER BY position
          ";
