...
class Active_inventory_report_model extends CI_Model
	{
	 ...
	 public function get_product_list($orderby='prod_id',$direction='DESC',$offet,$limit,$searchterm='')
    {
		...
		// print_r($cnt);
         $sqlcount="SELECT count(*) as total from active_inventory_data WHERE added_by={$this->user_id} ";
         $sqlquery= "SELECT * FROM active_inventory_data  WHERE added_by={$this->user_id} ";
